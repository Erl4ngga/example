...
class PostCategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.backend.postcategory.index')->with('postCategories',$postCategory)->with('profile',$profile);
    }
    ...
    {
        $profile=Auth()->user();
        return view('pages.backend.postcategory.create')->with('profile',$profile);
    }
    ...
    public function edit($id)
    {
        ...
        $profile=Auth()->user();
        return view('pages.backend.postcategory.edit')->with('postCategory',$postCategory)->with('profile',$profile);
    }
