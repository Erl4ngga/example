...
class PostTagController extends Controller
{
    ...
    public function index()
    {
        ...
        $profile=Auth()->user();
        return view('pages.backend.posttag.index')->with('postTags',$postTag)->with('profile',$profile);
    }
    ...
    {
        $profile=Auth()->user();
        return view('pages.backend.posttag.create')->with('profile',$profile);
    }
    ...
    public function edit($id)
    {
        ...
        $profile=Auth()->user();
        return view('pages.backend.posttag.edit')->with('postTag',$postTag)->with('profile',$profile);
    }
